...
export default class CmTournaments extends LightningElement {
	...
	set allTournamentResults(val){
		...
		console.log('this._allTournamentResults: ', JSON.parse(JSON.stringify(this._allTournamentResults)));
		...
		console.log('this.tournaments: ', JSON.parse(JSON.stringify(this.tournaments)));
